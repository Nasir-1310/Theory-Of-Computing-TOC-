       ...
       // double t_half=Ttotal/2;
        ...
        while(t<=Ttotal)
        {
         ...
         /*   if(option==1)
            ...
            cleardevice();
            if(t<=t_half){
            rectangle(60+y,350-y,90+y,380-y);
            ...
            d=380-y;
                ...
                rectangle(a+y,b+y,c+y,d+y);// go maddomic corno
            }
            */

           // rectangle(60,350+y,90,380+y);//move dowm
           // rectangle(60+y,350,90+y,380);//move left
             //rectangle(60+y,350+y,90+y,380+y);
          /*  if(t<=t_half)
             rectangle((y1+10),(y1+10),(y1+100),(y1+100));
             else
             rectangle((x+10),(x+10),(x+100),(x+100));
             ?*/
...
void Mechanics()
{
    ...
    double m1=-1,m2=-1,u1=-1,u2=-1,v1=-1,v2=-1;
    ...
    if(v1==-1)
    {
         finalV=conservation_of_momentum(m1,u1,m2,u2,v2,m1);
        if(finalV!=0)
        {
            printf("Final velocity of the First object is : %lf\n",finalV);
            return;
        }
    }
    else {
         finalV=conservation_of_momentum(m1,u1,m2,u2,v1,m2);
          if(finalV!=0)
        {
            printf("Final velocity of the Second object is : %lf\n",finalV);
            return;
        }
    }
